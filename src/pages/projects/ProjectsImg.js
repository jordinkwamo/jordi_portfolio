  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <ellipse cx="843.39" cy="664.8" rx="192" ry="43" fill={theme.imageHighlight} opacity="0.1" />
        <g opacity="0.1">
          <path
        ...
        <rect x="457" y="170.7" width="70.01" height="33.22" rx="8.57" fill={theme.imageHighlight} opacity="0.2" />
        <rect x="598.84" y="170.7" width="70.01" height="33.22" rx="8.57" fill={theme.imageHighlight} opacity="0.2" />
        <polyline
        ...
        <rect x="510.55" y="292.79" width="102.68" height="48.73" rx="8.57" fill={theme.imageHighlight} />
        <line x1="492.29" y1="170.7" x2="491.38" y2="138.35" fill="none" stroke={theme.text} stroke-miterlimit="10" />
        <polyline
          ...
          stroke-miterlimit="10"
        />
        <rect x="456.61" y="106.7" width="70.01" height="33.22" rx="8.57" fill={theme.imageHighlight} opacity="0.2" />
        <rect x="640.21" y="106.7" width="70.01" height="33.22" rx="8.57" fill={theme.imageHighlight} opacity="0.2" />
        <rect x="555.81" y="106.7" width="70.01" height="33.22" rx="8.57" fill={theme.imageHighlight} opacity="0.2" />
        <line x1="561.89" y1="341.51" x2="561.62" y2="430.01" fill="none" stroke={theme.text} stroke-miterlimit="10" />
        <path
          d="M609.53,558.59v0Z"
          transform="translate(-48.1 -96.1)"
          fill="none"
        ...
        <polyline
          ...
          stroke-miterlimit="10"
        />
        <rect x="526.62" y="430.01" width="70.01" height="33.22" rx="8.57" fill={theme.imageHighlight} opacity="0.2" />
        <rect
          x="861.88"
          y="345.12"
          width="70.01"
        ...
        <rect
          ...
          opacity="0.2"
        />
        <rect x="625.82" y="492.66" width="70.01" height="33.22" rx="8.57" fill={theme.imageHighlight} opacity="0.2" />
        <rect
          x="475.52"
          y="588.76"
          width="70.01"
        ...
        <rect
          ...
          opacity="0.2"
        />
        <line x1="801" y1="320.45" x2="832.16" y2="374.94" fill="none" stroke={theme.text} stroke-miterlimit="10" />
        <line x1="735.11" y1="319.78" x2="767.82" y2="319.78" fill="none" stroke={theme.text} stroke-miterlimit="10" />
        <line x1="613.23" y1="317.15" x2="702.51" y2="319.78" fill="none" stroke={theme.text} stroke-miterlimit="10" />
        <line x1="832.16" y1="265.63" x2="801.15" y2="320.21" fill="none" stroke={theme.text} stroke-miterlimit="10" />
        <rect
          x="732.22"
          y="399.07"
          width="70.01"
        ...
        <rect
          ...
          opacity="0.2"
        />
        <line x1="322.78" y1="320.45" x2="291.61" y2="374.94" fill="none" stroke={theme.text} stroke-miterlimit="10" />
        <line x1="388.66" y1="319.78" x2="355.96" y2="319.78" fill="none" stroke={theme.text} stroke-miterlimit="10" />
        <line x1="510.55" y1="317.15" x2="421.27" y2="319.78" fill="none" stroke={theme.text} stroke-miterlimit="10" />
        <line x1="291.61" y1="265.63" x2="322.62" y2="320.21" fill="none" stroke={theme.text} stroke-miterlimit="10" />
        <rect
          x="417.76"
          y="399.07"
          width="70.01"
        ...
        <rect
          ...
          opacity="0.2"
        />
        <path d="M156.12,598c0,50.24,31.52,90.9,70.47,90.9" transform="translate(-48.1 -96.1)" fill="#46455b" />
        <path
        ...
        <path
          ...
          fill={theme.imageHighlight}
        />
        <path d="M226.59,688.89c0-64.92,40.66-117.45,90.9-117.45" transform="translate(-48.1 -96.1)" fill="#46455b" />
        <ellipse cx="175.43" cy="607.19" rx="17.52" ry="2.96" fill={theme.imageHighlight} opacity="0.1" />
        <path
        ...
        <path
          ...
          opacity="0.05"
        />
        <path d="M829.58,710.55s12.29,4,22.7,18.16Z" transform="translate(-48.1 -96.1)" opacity="0.1" />
        <g opacity="0.1">
          <path
