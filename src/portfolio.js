...
const greeting = {
  ...
  nickname: '',
  subTitle: `Développeur de logiciels Full Stack avec deux ans d'expérience dans le développement d'applications Web robustes et évolutives, je possède une base en développement front-end et back-end, concentré sur la conception de solutions à des problèmes complexes.`,
  resumeLink: '',
...
const degrees = {
  degrees: [
    ...
    {
      title: 'Université Numérique Paris',
      subtitle: 'Certificat de Développement Logiciel',
  ...
  sections: [
    {
      ...
      experiences: [
        ...
        },
        {
          ...
          duration: 'Octobre 2022 – Mars 2024',
          ...
          description: `Assister le directeur des ventes dans les opérations quotidiennes:
            ...
            ●	Passer à la caisse et recevoir le paiement des clients lorsque les caissiers ne sont pas disponibles,
...
const contactPageData = {
  contactSection: {
    title: 'Contact Me',
    profile_image_path: '',
    description: 'I am available to discuss anytime. I can help you with full stack web app development',
  },
  // blogSection: {
  //   title: 'Blogs',
  //   subtitle:
